package com.joannegton.psy_terapeutabot.ui
...
object Interation {
    private const val API_URL = "https://1767-45-179-106-136.ngrok-free.app/api/v1/interacoes/"
    ...
    fun getMessages(id_usuario: Int, id_terapeuta: String, callback: (List<Message>) -> Unit) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                callback(emptyList())
                Log.e("TAG", "Erro ao processar respostaaa: ${e.message}")
            }
        }
    }
}
